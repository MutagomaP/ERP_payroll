...
import com.rwanda.gov.erp.security.JwtAuthenticationFilter;
import com.rwanda.gov.erp.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/deduction-rates/**").hasRole("ADMIN")
                .requestMatchers("/api/payroll/generate").hasRole("MANAGER")
                .requestMatchers("/api/payroll/*/approve").hasRole("ADMIN")
                .requestMatchers("/api/payroll/my-payslips").hasAnyRole("EMPLOYEE", "ADMIN", "MANAGER")
